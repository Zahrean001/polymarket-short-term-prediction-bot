...
if (runnerFailed || totalFailed > 0 || total === 0) {
  console.error(`V374.7 sequential unit/regression verification FAILED (${totalPassed}/${total}, ${files.length} files)`);
  process.exit(1);
}
console.log(`V374.7 sequential unit/regression verification PASSED (${totalPassed}/${total}, ${files.length} files)`);
