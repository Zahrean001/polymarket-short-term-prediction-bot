...
function validMain(overrides = {}) {
  return {
    BOT_ROLE: "main_test",
    DATA_DIR: "server/data-main-v3745",
    MAIN_SETTLEMENT_DIR: "server/data-main-v3745/settlements",
    OBSERVER_CHECKPOINT_DIR: "server/data-observer-v3745/research/canonical-checkpoints",
    OBSERVER_POLICY_PATH: "server/data-observer-v3745/policy/observer-policy-v3745.json",
    OBSERVER_STATE_PATH: "server/data-observer-v3745/observer/settlement-cursor-v3745.json",
...
test("runtime config keeps main and observer data paths isolated", () => {
  ...
  assert.throws(() => validateV373RuntimeConfig(validMain({ OBSERVER_POLICY_PATH: "server/data-main-v3745/policy.json" })), /data_paths_must_be_separate/);
});
