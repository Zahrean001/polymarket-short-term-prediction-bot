...
const required = [
  ...
  "tools/verify-v3746-frozen-core.js",
  "tools/verify-v3746-observer-runtime-smoke.js",
  "V3745_FROZEN_CORE.sha256",
  "V3746_RETROSPECTIVE_EVIDENCE.json",
  "V3746_VERIFICATION_REPORT.md",
  "INSTALL_V3746_PAPER.md",
...
if (!ok) {
  console.error("V374.6 anti-downgrade source-only clean-package verifier FAILED");
  process.exit(1);
}
console.log("V374.6 anti-downgrade source-only clean-package verifier PASSED");
