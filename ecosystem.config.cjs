const mainDataDir = process.env.MAIN_DATA_DIR || "server/data-main-v3747";
const observerDataDir = process.env.OBSERVER_DATA_DIR || "server/data-observer-v3747";
...
const mainEnv = Object.freeze({
  ...
  BOT_HOST: "127.0.0.1",
  BOT_ROLE: "main_test",
  BOT_INSTANCE_ID: "main-direction-shadow-fastgrow-v3747",
  ...
  MAIN_SIGNAL_DIR: process.env.MAIN_SIGNAL_DIR || `${mainDataDir}/signals`,
  ...
  OBSERVER_POLICY_PATH: process.env.OBSERVER_POLICY_PATH || `${observerDataDir}/policy/observer-policy-v3747.json`,
  OBSERVER_STATE_PATH: process.env.OBSERVER_STATE_PATH || `${observerDataDir}/observer/settlement-cursor-v3747.json`,
  ...
  DIRECTION_SHADOW_DECISION_DIR: process.env.DIRECTION_SHADOW_DECISION_DIR || `${observerDataDir}/research/direction-only-decisions`,
  DIRECTION_SHADOW_STATE_PATH: process.env.DIRECTION_SHADOW_STATE_PATH || `${observerDataDir}/observer/direction-only-cursor-v3747.json`,
  DIRECTION_SHADOW_REPORT_PATH: process.env.DIRECTION_SHADOW_REPORT_PATH || `${observerDataDir}/reports/direction-only-shadow-latest.json`,
...
module.exports = {
  apps: [
    ...
    {
      name: "polymarket-direction-observer-v3747",
      script: "server/index.js",
      cwd: __dirname,
      interpreter: "node",
      autorestart: true,
      ...
      env: {
        ...
        BOT_INSTANCE_ID: "direction-settlement-observer-v3747",
